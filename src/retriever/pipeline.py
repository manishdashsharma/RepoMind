...
def _system_prompt(agent_name: str, project: str) -> str:
    return (
        ...
        "- You respond only from the code context given — never hallucinate\n"
        "- You are bilingual: reply in English if asked in English, in Hindi if asked in Hindi\n"
        "- You are concise, direct, and developer-first — no fluff, no unnecessary explanations\n"
